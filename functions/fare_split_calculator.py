# use your knowledge of using multiple parameters to create a function that splits a Doober fare with several users

def split_fare(fare, passengers, feature_cost):
    share = fare/passengers
    print(f"Spltting the ${fare} fare between {passengers} passengers...")
